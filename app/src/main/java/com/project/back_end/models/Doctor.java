...
//    - Standard getter and setter methods are provided for all fields: id, name, specialty, email, password, phone, and availableTimes.
    ...
    //use availableTimes as local input par will display an error

    public void setAvailableTimes(List<String> t_availableTimes) {
        this.availableTimes = t_availableTimes;
    }
